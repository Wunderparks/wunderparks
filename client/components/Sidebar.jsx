...
const Sidebar = ({ setData }) => {
  return (
    <div id="sidebar">
      ...
      <h3>Date Visited:</h3>
      <input type="date" id="date_visited" value="date_visited" />
      ...
      <input type="checkbox" value="Guided Tours">
        Guided Tours
      </input>
      <input type="checkbox" value="Hiking">
        Hiking
      </input>
      <input type="checkbox" value="Paddling">
        Paddling
      </input>
      <input type="checkbox" value="Snorkeling">
        Snorkeling
      </input>
      <input type="checkbox" value="Swimming">
        Swimming
      </input>
      <input type="checkbox" value="Wildlife Watching">
        Wildlife Watching
      </input>
